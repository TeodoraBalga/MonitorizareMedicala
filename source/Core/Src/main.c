...
/* Definitions for TaskPuls */
osThreadId_t TaskPulsHandle;
const osThreadAttr_t TaskPuls_attributes = {
  .name = "TaskPuls",
  .priority = (osPriority_t) osPriorityHigh,
  .stack_size = 128 * 4
};
/* Definitions for TaskTemp */
osThreadId_t TaskTempHandle;
const osThreadAttr_t TaskTemp_attributes = {
  .name = "TaskTemp",
...
/* Definitions for TaskBuzz */
osThreadId_t TaskBuzzHandle;
const osThreadAttr_t TaskBuzz_attributes = {
  .name = "TaskBuzz",
...
/* USER CODE BEGIN Header_StartTaskPuls */
/**
  * @brief  Function implementing the TaskPuls thread.
...
/* USER CODE BEGIN Header_StartTaskBuzz */
/**
* @brief Function implementing the TaskBuzz thread.
* @param argument: Not used
* @retval None
*/
